'use strict';
importScripts('./runtime-manifest.js?v=7.1.0');

const RUNTIME=self.CUTCOACH_RUNTIME;
const CACHE_PREFIX='cutcoach-';
const CACHE_NAME=`cutcoach-v${RUNTIME.version}`;
const APP_SHELL=['./','./index.html','./runtime-manifest.js?v=7.1.0',...RUNTIME.baseAssets,...RUNTIME.styles,...RUNTIME.scripts,'./update.html'];
