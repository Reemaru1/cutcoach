'use strict';
importScripts('./runtime-manifest.js?v=1.3.1-alpha');
const RUNTIME=self.CUTCOACH_RUNTIME;
const CACHE_PREFIX='cutcoach-';
const CACHE_NAME=`cutcoach-v${RUNTIME.version}-nav131`;
const APP_SHELL=['./','./index.html','./runtime-manifest.js?v=1.3.1-alpha',...RUNTIME.baseAssets,...RUNTIME.styles,...RUNTIME.scripts,'./update.html'];
