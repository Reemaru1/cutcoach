'use strict';
importScripts('./runtime-manifest.js?v=1.2.5-alpha');
const RUNTIME=self.CUTCOACH_RUNTIME;
const CACHE_PREFIX='cutcoach-';
const CACHE_NAME=`cutcoach-v${RUNTIME.version}`;
const APP_SHELL=['./','./index.html','./runtime-manifest.js?v=1.2.5-alpha',...RUNTIME.baseAssets,...RUNTIME.styles,...RUNTIME.scripts,'./update.html'];
