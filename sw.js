'use strict';
importScripts('./runtime-manifest.js?v=2.3.0-settings1014');
...
const APP_SHELL=['./','./index.html','./runtime-manifest.js?v=2.3.0-settings1014',...RUNTIME.baseAssets,...RUNTIME.styles,...RUNTIME.scripts,'./update.html'];
