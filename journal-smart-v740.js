...
(function(){
  ...
  function loadLive127(){
    if(!document.querySelector('link[data-cutcoach-glass-nav]')){const link=document.createElement('link');link.rel='stylesheet';link.href='./journal-live-nav-v127.css?v=1.3.0-alpha';link.dataset.cutcoachGlassNav='1';document.head.append(link)}
    if(!window.CutCoachJournalLive127&&!document.querySelector('script[data-journal-live-nav-v130]')){const script=document.createElement('script');script.src='./journal-live-nav-v127.js?v=1.3.0-alpha';script.async=false;script.dataset.journalLiveNavV130='1';document.head.append(script)}
  }
