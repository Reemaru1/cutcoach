...
(function(){
  ...
  function loadLive127(){
    if(!document.querySelector('link[data-journal-live-nav-v127]')){const link=document.createElement('link');link.rel='stylesheet';link.href='./journal-live-nav-v127.css?v=1.2.7-alpha';link.dataset.journalLiveNavV127='1';document.head.append(link)}
    if(!window.CutCoachJournalLive127&&!document.querySelector('script[data-journal-live-nav-v127]')){const script=document.createElement('script');script.src='./journal-live-nav-v127.js?v=1.2.7-alpha';script.async=false;script.dataset.journalLiveNavV127='1';document.head.append(script)}
  }
