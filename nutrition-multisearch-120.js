...
(function(){
  ...
  const ASSETS=[
    ...
    {selector:'script[data-nutrition-search-learning-v160],script[data-search-learning-v160]',dataset:'nutritionSearchLearningV160',src:'./nutrition-search-learning-v160.js?v=1.6.0-alpha',ready:()=>Boolean(window.CutCoachSearchLearning160)},
  ...
  function attachLayers(){let current=engine();current=window.CutCoachSearchConfidenceHardening151?.attach?.(current)||current;current=window.CutCoachPortionHardening153?.attach?.(current)||current;window.CutCoachSearchLearning160?.installLibraryHook?.();ensureFirstHardenedRender()}
