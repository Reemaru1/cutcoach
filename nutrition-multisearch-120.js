...
(function(){
  ...
  const ASSETS=[
    ...
    {selector:'script[data-nutrition-search-exact-whole-v170],script[data-search-exact-whole-v170]',dataset:'nutritionSearchExactWholeV170',src:'./nutrition-search-exact-whole-v170.js?v=1.7.0-alpha',ready:()=>Boolean(window.CutCoachSearchExactWhole170)},
