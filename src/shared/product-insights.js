...
(function(root){
  ...
  function read(){
    try{
      ...
      const base=empty();
      return{...base,...parsed,onboarding:{...base.onboarding,...parsed.onboarding,duration:{...base.onboarding.duration,...parsed.onboarding?.duration}},features:{...base.features,...parsed.features},actions:{...base.actions,...parsed.actions},search:{...base.search,...parsed.search,length:{...base.search.length,...parsed.search?.length},latency:{...base.search.latency,...parsed.search?.latency}},accessibility:{...base.accessibility,...parsed.accessibility}};
    }catch{return empty()}
  }
  function write(data){
