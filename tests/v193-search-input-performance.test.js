...
(async()=>{
  ...
  assert.match(loader,/nutrition-search-input-performance-v193\.js\?v=1\.9\.5-alpha/,'Loader verwendet nicht die stabile Eingabegeneration.');
  assert.match(loader,/script\.onload=loadPolish/,'Performance-Schicht startet den Such-Polisher nicht erst nach erfolgreichem Laden.');
