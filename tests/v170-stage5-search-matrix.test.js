...
const catalog=[
  {id:'ccmeal:menemen',name:'Menemen',aliases:['Türkisches Rührei','Menemen mit Ei'],amount:350,unit:'g',calories:430,protein:23,carbs:20,fat:28,source:'cutcoach',catalog:true,estimated:true,sourceLabel:'CutCoach Standardgericht · durchschnittlicher Richtwert'},
  {id:'ccmeal:menemen-sucuk',name:'Menemen mit Sucuk',aliases:['Sucuklu Menemen'],amount:400,unit:'g',calories:650,protein:32,carbs:22,fat:47,source:'cutcoach',catalog:true,estimated:true,sourceLabel:'CutCoach Standardgericht · durchschnittlicher Richtwert'},
  {id:'ccmeal:simit',name:'Simit',aliases:['Türkischer Sesamring'],amount:120,unit:'g',calories:410,protein:13,carbs:62,fat:13,source:'cutcoach',catalog:true,estimated:true,sourceLabel:'CutCoach Standardgericht · durchschnittlicher Richtwert'},
  {id:'ccde:doner-kalb',name:'Döner Kebab Kalb/Rind',aliases:['Döner','Kebab'],amount:550,unit:'g',calories:850,protein:45,carbs:82,fat:34,source:'cutcoach',catalog:true,estimated:true,sourceLabel:'CutCoach Standardgericht · durchschnittlicher Richtwert'},
  {id:'ccmeal:goezleme-spinat',name:'Gözleme mit Spinat und Käse',aliases:['Spinat Gözleme'],amount:300,unit:'g',calories:590,protein:22,carbs:67,fat:25,source:'cutcoach',catalog:true,estimated:true,sourceLabel:'CutCoach Standardgericht · durchschnittlicher Richtwert'},
  {id:'ccde:nudeln-tomatensauce',name:'Nudeln mit Tomatensauce',aliases:['Pasta Pomodoro'],amount:480,unit:'g',calories:620,protein:20,carbs:100,fat:15,source:'cutcoach',catalog:true,estimated:true,sourceLabel:'CutCoach Standardgericht · durchschnittlicher Richtwert'},
  ...
  {id:'dish-milchreis',name:'Milchreis',aliases:[],amount:300,unit:'g',calories:360,protein:10,carbs:60,fat:8,source:'cutcoach',estimated:true,sourceLabel:'CutCoach Standardgericht · durchschnittlicher Richtwert'},
