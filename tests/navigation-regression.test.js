...
assert.ok(glass.includes("document.querySelector('#journalQuickAdd:not([disabled]),[data-add-journal-meal]:not([disabled])')"),'Ernährungsbutton muss den produktiven Quick-Add-Ablauf mit Mahlzeitenfallback bevorzugen.');
...
assert.ok(smart.includes(`journal-live-nav-v127.js?v=${packageJson.version}`),'Smart-Journal muss die aktuelle Live-Navigation laden.');
