...
(async()=>{
  await wait(650);
  assert.equal(node('#appVersion').textContent,'Version 7.2.0','Sichtbare Releaseversion ist nicht 7.2.0');
  assert.equal(window.CUTCOACH_RELEASE,'7.2.0','Zentrale Releasekonstante ist nicht 7.2.0');
