...
(async()=>{
 ...
 assert.equal(api.version,'1.9.0-alpha');assert.equal(api.build,'1.9.0-search-integrity');assert.equal(w.CutCoachNutritionMultiSearch120.version,'1.9.6-compat');
 ...
 dom.window.close();console.log('Confidence- und Ranking-Hardening bleibt unter Artikel-/Sequenzintegrität 1.9.6 stabil.');
