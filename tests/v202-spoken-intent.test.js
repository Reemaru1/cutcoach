...
(async()=>{
  ...
  assert.match(sw,/search202-spoken-intent/);assert.match(sw,/voice203-direct-permission/);assert.match(sw,/`\$\{VOICE_CACHE\}-energy143-nutrition220-nav137-dashboard820-searchmetrics110-faststart-search721-worker-index100-ui232-entry-flows`/);
