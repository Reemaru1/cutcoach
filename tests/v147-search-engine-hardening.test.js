...
const profilePos=loader.indexOf('nutrition-portion-profiles-v153.js?v=1.5.3-alpha'),portionPos=loader.indexOf('nutrition-portion-hardening-v153.js?v=1.5.3-alpha'),canonicalPos=loader.indexOf('nutrition-multisearch-canonical-128.js?v=1.5.0-alpha');assert.ok(profilePos>=0&&profilePos<portionPos&&portionPos<canonicalPos);assert.match(manifest,/nutrition-portion-profiles-v153\.js\?v=1\.5\.3-alpha/);assert.match(manifest,/nutrition-portion-hardening-v153\.js\?v=1\.5\.3-alpha/);assert.match(manifest,/nutrition-multisearch-canonical-128\.js\?v=1\.5\.0-alpha/);assert.match(sw,/search153-portions/);
dom.window.close();console.log('Such-Engine 1.5.0 bleibt unter Portionsschicht 1.5.3 stabil.');