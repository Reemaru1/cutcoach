...
const dom=new JSDOM(`<!doctype html><html><head><link rel="stylesheet" href="src/features/journal/dashboard-v800.css?v=8.0.1-alpha"></head><body class="journal-mode cc-glass-nav-active"><div class="app"><main><section class="screen active" data-screen="today"><div id="today560">
...
setTimeout(()=>{
  ...
  for(const asset of ['src/shared/design-system-v800.css?v=8.0.1-alpha','src/features/journal/dashboard-v800.css?v=8.0.1-alpha','src/features/journal/dashboard-v800.js?v=8.0.1-alpha']){assert.ok(index.includes(asset));assert.ok(manifest.includes(asset))}
