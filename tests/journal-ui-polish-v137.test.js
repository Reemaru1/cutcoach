...
setTimeout(()=>{
  ...
  setTimeout(()=>{
    ...
    assert.ok(sw.includes('-nav136-journal137-nutrition138-dishes140-dashboard801`'),'Service Worker verwendet nicht die aktuelle Tagebuch-, Ernährungs- und Dashboard-Cachegeneration.');
