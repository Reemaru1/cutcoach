...
(async()=>{
  ...
  assert.ok(sw.includes('`${STABILITY_CACHE}-energy143`'),'Die Cachegeneration für Tageskurs und Suchstabilität ist nicht verkettet.');
  ...
  assert.ok(sw.includes('search195-stability'),'Suchstabilitätsgeneration fehlt vor dem Tageskurs-Cache.');

  dom.window.close();
  console.log('Tageskurs, Interaktions-Hotfix und Suchstabilität sind ohne Render-Schleifen korrekt verkettet.');
