...
(async()=>{
  ...
  assert.ok(sw.includes('`${STAGE6_CACHE}-energy143`'),'Die Cachegeneration für Tageskurs und Stufe-6-Produktionsabnahme ist nicht verkettet.');
  ...
  assert.ok(sw.includes('stage6-production180'),'Stufe-6-Cachegeneration fehlt vor dem Tageskurs-Cache.');
