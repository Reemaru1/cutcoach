...
source=source.replaceAll("'Version 7.2.0'","'Version 7.3.0'");
source=source.replaceAll("'7.2.0','Zentrale Releasekonstante ist nicht 7.2.0'","'7.3.0','Zentrale Releasekonstante ist nicht 7.3.0'");
source=source.replace("  console.log('CutCoach 7.2 smoke test: ok');","  assert.ok(window.CutCoachEverydayCatalog,'Alltagskatalog fehlt');\n  assert.ok(window.document.querySelector('#nutritionEverydayQuick'),'Schnellzugriff auf Alltagsgerichte fehlt');\n  console.log('CutCoach 7.3 journal smoke test: ok');");
