...
source=source.replace("/version:'7\\.1\\.0'/","/version:'1\\.0\\.3-alpha'/");
source=source.replace("/runtime-manifest\\.js\\?v=7\\.1\\.0/","/runtime-manifest\\.js\\?v=1\\.0\\.3-alpha/");
source=source.replace("/sw\\.js\\?v=7\\.1\\.0-force/","/sw\\.js\\?v=1\\.0\\.3-alpha-force/");
source=source.replace("/updated=710/","/updated=103a/");
