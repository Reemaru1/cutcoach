...
source=source.replaceAll("'Version 7.1.0'","'Version 1.0.0 Alpha'");
source=source.replaceAll("'7.1.0','Zentrale Releasekonstante fehlt'","'1.0.0 Alpha','Zentrale Releasekonstante fehlt'");
source=source.replace(/version:'7\\\.1\\\.0'/g,"version:'1\\.0\\.0-alpha'");
source=source.replace(/runtime-manifest\\\.js\\\?v=7\\\.1\\\.0/g,'runtime-manifest\\.js\\?v=1\\.0\\.0-alpha');
source=source.replace(/sw\\\.js\\\?v=7\\\.1\\\.0-force/g,'sw\\.js\\?v=1\\.0\\.0-alpha-force');
source=source.replaceAll('updated=710','updated=100a');
