...
source=source.replaceAll("'Version 7.1.0'","'Version 7.3.2'");
source=source.replaceAll("'7.1.0','Zentrale Releasekonstante fehlt'","'7.3.2','Zentrale Releasekonstante fehlt'");
source=source.replace(/version:'7\\\.1\\\.0'/g,"version:'7\\.3\\.2'");
source=source.replace(/runtime-manifest\\\.js\\\?v=7\\\.1\\\.0/g,'runtime-manifest\\.js\\?v=7\\.3\\.2');
source=source.replace(/sw\\\.js\\\?v=7\\\.1\\\.0-force/g,'sw\\.js\\?v=7\\.3\\.2-force');
source=source.replaceAll('updated=710','updated=732');
