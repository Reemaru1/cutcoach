...
source=source.replaceAll("'Version 7.1.0'","'Version 7.3.1'");
source=source.replaceAll("'7.1.0','Zentrale Releasekonstante fehlt'","'7.3.1','Zentrale Releasekonstante fehlt'");
source=source.replace(/version:'7\\\.1\\\.0'/g,"version:'7\\.3\\.1'");
