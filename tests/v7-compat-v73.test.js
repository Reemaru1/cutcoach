...
source=source.replaceAll("'Version 7.1.0'","'Version 1.2.0 Alpha'");
source=source.replaceAll("'7.1.0','Zentrale Releasekonstante fehlt'","'1.2.0 Alpha','Zentrale Releasekonstante fehlt'");
source=source.replace("/version:'7\\.1\\.0'/","/version:'1\\.2\\.0-alpha'/");
source=source.replace("/runtime-manifest\\.js\\?v=7\\.1\\.0/","/runtime-manifest\\.js\\?v=1\\.2\\.0-alpha/");
source=source.replace("/sw\\.js\\?v=7\\.1\\.0-force/","/sw\\.js\\?v=1\\.2\\.0-alpha-force/");
source=source.replace("/updated=710/","/updated=120a/");
