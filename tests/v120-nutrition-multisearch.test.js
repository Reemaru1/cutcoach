...
assert.match(version,/nutrition-multisearch-120\.js\?v=1\.2\.2-alpha/,'Exakte Suchlogik wird nicht geladen');
...
assert.match(manifest,/nutrition-multisearch-120\.js\?v=1\.2\.2-alpha/,'Exakte Suchlogik fehlt im Cache');
