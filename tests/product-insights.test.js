...
(async()=>{
  ...
  dom.window.dispatchEvent(new dom.window.CustomEvent('cutcoach:nutrition-search-rendered',{detail:{hasQuery:true,resultCount:8,queryLengthBucket:'medium',latencyMs:180,searchRevision:1,query:'dieser Suchtext ist privat'}}));
  dom.window.dispatchEvent(new dom.window.CustomEvent('cutcoach:nutrition-search-rendered',{detail:{hasQuery:true,resultCount:8,queryLengthBucket:'medium',latencyMs:190,searchRevision:1}}));
