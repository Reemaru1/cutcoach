...
(function(){
  ...
  window.feedback=function(){
    ...
    if(data.alcohol===true)lines.push('⚠️ Regeneration durch Alkohol reduziert');else if(data.alcohol===false)lines.push('✅ Regeneration: alkoholfrei');
  ...
  function ensureInfoModal(){
    ...
    const modal=document.querySelector('#coachInfoModal'),close=()=>closeModal(modal);document.querySelector('#coachInfoClose').onclick=close;modal.onclick=event=>{if(event.target===modal)close();};
  }
